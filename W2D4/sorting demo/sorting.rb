...
class SortingDemo
  ...
  def self.run_performance_tests(multiplier = 1, rounds = 3)
    [1, 10, 100, 1000, 1000000].each do |size|
      size *= multiplier
      wait_for_keypress(
...
# From the Big-O, I assumed taht
# for 100,000 elements, total running time for Merge Sort is 20 seonds
# for 100,000 elements, total running time for Bubble Sort is 100,000^2 seconds or 126 years
